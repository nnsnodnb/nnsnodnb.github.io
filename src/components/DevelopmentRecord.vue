                ...
                <td>
                    <div v-for="(note, index) in record.notes" :key="index">
                        ...
                        <span v-else-if="note.type === 'app-store'">
                            <AppStoreBadge :app_id="note.data.app_id" :locale="note.data.locale || 'en'" type="appstore"/>
                        </span>
                        <span v-else-if="note.type === 'app-store-download-count'">
                            <AppStoreBadge :app_id="note.data.app_id" :locale="note.data.locale || 'en'" type="download-count"/>
                        </span>
